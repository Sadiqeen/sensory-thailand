                        ...
                        <div class="card-body row">
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" name="question[]" id=""
                                    class="form-control @error('question.'.$loop->index) is-invalid @enderror"
                                    value="{{ old('question')[$loop->index] }}" placeholder="Question">
                                @error('question.'.$loop->index)
                                <span class="invalid-feedback" role="alert">
                                    <strong>{!! str_replace( 'question.'.$loop->index, 'question', $message )
                                        !!}</strong>
                                </span>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="test_choice[]" id="">
                                    ...
                                    <option value="2" @if(old('test_choice')[$loop->index] == 2) selected
                                        @endif>เลือกได้ตัวเลือกเดียว</option>
                                </select>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="">คำตอบที่ 1</label>
                                <input type="text" name="answer1[]" id=""
                                    class="form-control @error('answer1.'.$loop->index) is-invalid @enderror"
                                    value="{{ old('answer1')[$loop->index] }}" placeholder="Answer 1">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="answer2[]" id=""
                                    class="form-control @error('answer2.'.$loop->index) is-invalid @enderror"
                                    value="{{ old('answer2')[$loop->index] }}" placeholder="Answer 2">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="answer3[]" id=""
                                    class="form-control @error('answer3.'.$loop->index) is-invalid @enderror"
                                    value="{{ old('answer3')[$loop->index] }}" placeholder="Answer 3">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="answer4[]" id=""
                                    class="form-control @error('answer4.'.$loop->index) is-invalid @enderror"
                                    value="{{ old('answer4')[$loop->index] }}" placeholder="Answer 4">
...
<script>
    function addQuestion(questionId) {
        ...
        $("#Questions").append(
            ...
            '</div>' +
            '<div class="col-md-12">' +
            '<button type="button" id="btn-' + (questionId + 1) + '" onclick="addQuestion(' + (questionId + 1) +
            ')" class="float-right btn btn-success btn-xs btn-block">' +
            '<i class="fa fa-plus-square-o"></i> เพิ่มคำถาม' +
            '</button>' +
            '</div>' +
